...
| `arcana` binary | Built from a checkout of this repository with `cargo install --locked --path crates/cli`; the crates.io package is not published (see [`install.md`](install.md)). |
