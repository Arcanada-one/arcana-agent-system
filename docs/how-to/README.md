...
Problem-solving recipes. Each page solves one concrete task.

- [`testing.md`](testing.md) — run tests, coverage.
...
- [`run-a-work-item.md`](run-a-work-item.md) — execute one Muneral work item under its KC2 contract. Written by the agent itself under that contract (A2-292); the index line is ours.
