...
The key file is a PEM-encoded Ed25519 private key (the agent identity).
Export it:
...
```bash
export ARCANA_MODEL="anthropic.claude-sonnet-4-20250514"
...
i mmediately. No receipt is written; the exit code is 1:
